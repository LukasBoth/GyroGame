...
#define HSYNC_START 32              ///< See datasheet
#define HSYNC_PW 96                 ///< See datasheet
#define HSYNC_FINETUNE 0            ///< See datasheet
#define HSYNC_NONDISP 26            ///< See datasheet
#define VSYNC_PW 2            ///< See datasheet
